...
/**
 * This is the main class to operate.
 */
public class IntegratedConverter {
    ...
    /**
     * main method makes an instance of converter, and runs the run method.
     * run method calls any converters, using parameters that user typed.
     * If there is no profit converter, the method prints out that that kind of converter does not exist.
     * If the last parameter is equal to "all", not considering uppercase or lowercase, the method calls unique class named AllConverter and execute it.
     */
